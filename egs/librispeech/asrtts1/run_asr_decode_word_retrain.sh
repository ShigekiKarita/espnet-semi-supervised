...
lmexpdir=exp/train_word_rnnlm_2layer_bs256
lm_vocabsize=65000
lmdict=data/local/wordlm_train/wordlist_${lm_vocabsize}.txt
...
if [ ${stage} -le 6 ]; then
    ...
    (
	rtask=${rtask}_asr
        decode_dir=wordlm${lm_weight}/decode_${rtask}_beam${beam_size}_e${recog_model}_p${penalty}_len${minlenratio}-${maxlenratio}_ctcw${ctc_weight}_rnnlm${lm_weight}
        ...
        ${decode_cmd} JOB=1:${nj} ${expdir}/${decode_dir}/log/decode.JOB.log \
            ...
            --word-rnnlm ${lmexpdir}/rnnlm.model.best \
            --word-dict ${lmdict} \
            --lm-weight ${lm_weight}
